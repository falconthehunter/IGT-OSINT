#!/usr/bin/env python3
# IGTPro Social Scan: Turbo Edition (Professional Power Scan)
import os
import json
import random
import asyncio
...
<html lang="en"><head>
<meta charset="UTF-8">
<title>IGTPro Social Results for {html_escape(username)}</title>
...
<h1>IGTPro Social Scan for <span style="color:#457b9d">{html_escape(username)}</span></h1>
...
<footer style="margin-top:2em;color:#888;">Generated by IGTPro Social Scan Turbo Edition</footer>
<script>
{chart_data}
const config = {{
  type: 'pie',
...
def main():
    console.print("[bold cyan]IGTPro Social Scan Turbo Edition[/bold cyan] — Facebook | Instagram | Twitter | Snapchat | Telegram | TikTok | Threads")
